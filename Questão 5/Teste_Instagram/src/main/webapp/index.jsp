...
<%@ page import="com.exceed_teste.examples.InstagramUtils" %>
...
<div class="container">
    ...
    <div class="jumbotron">
        <h1>INSTAGRAM</h1>
        <p class="lead">VERSAO ALTERADA do exemplo da biblioteca <a href="https://github.com/sachin-handiekar/jInstagram">jInstagram API</a></p>
